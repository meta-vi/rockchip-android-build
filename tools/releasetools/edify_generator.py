...
class EdifyGenerator(object):
  ...
  def WriteRawGptParameterImage(self):
    """update parameter"""
    self.script.append('package_extract_file("parameter", "/tmp/parameter");')
    self.script.append('write_raw_gpt_parameter() || abort("update parameter failed.");')
